		...
		<div class="sui-form-field">
			...
			>
				<input
					...
					aria-labelledby="hustle-customize-css-label"
					<?php checked( $settings['customize_css'], '1' ); ?>
				/>
				<span class="sui-toggle-slider" aria-hidden="true"></span>

				<span id="hustle-customize-css-label" class="sui-toggle-label"><?php esc_html_e( 'Enable custom CSS', 'hustle' ); ?></span>
			</label>
			...
			<div class="sui-background-frame" data-toggle-content="customize-css">
				...
				<div id="hustle_custom_css" style="height: 210px;"><?php echo $settings['custom_css']; ?></div> <?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
