...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://blossomthemes.com/theme-demo/?theme=blossom-pin' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'blossom-pin' ); ?>" target="_blank"><?php esc_html_e( 'View Demo', 'blossom-pin' ); ?></a>
    </div><!-- .panel-aside -->
</div>
