...
<div class="title-box">
    <div class="container">
        <h1 class="entry-title"><?php esc_html_e( 'Nothing Found', 'vw-pet-shop' ); ?></h1>
    </div>
</div>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<?php elseif ( is_search() ) : ?>
		<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'vw-pet-shop' ); ?></p>
		<?php get_search_form(); ?>
	<?php else : ?>
