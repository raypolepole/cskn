...
class VW_Pet_Shop_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'VW_Pet_Shop_About_Widget',
			__('VW About us', 'vw-pet-shop'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-pet-shop' ), ) 
		);
	}
	...
	public function form( $instance ) {
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-pet-shop'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-pet-shop'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-pet-shop'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-pet-shop'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-pet-shop'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-pet-shop'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vw_pet_shop_about_custom_load_widget() {
	register_widget( 'VW_Pet_Shop_About_Widget' );
}
add_action( 'widgets_init', 'vw_pet_shop_about_custom_load_widget' );