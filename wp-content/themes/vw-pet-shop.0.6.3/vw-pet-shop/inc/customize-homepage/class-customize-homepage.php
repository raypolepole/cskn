...
if ( ! class_exists( 'VW_Pet_Shop_Content_Creation' ) ) :

	/**
	 * VW_Pet_Shop_Content_Creation class.
	 */
	class VW_Pet_Shop_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * VW_Pet_Shop_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'VW_Pet_Shop_Content_Creation' );
			...
			<div class="content-themeinfo">
				<# if ( data.options ) { #>
					...
					<# if ( data.button_text && data.button_url ) { #>
						<a href="{{ data.button_url }}" class="button button-primary" target="_blank">{{
							data.button_text }}</a>
						<# } #>
