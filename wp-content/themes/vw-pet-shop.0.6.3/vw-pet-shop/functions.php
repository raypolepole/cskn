...
function vw_pet_shop_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'vw-pet-shop' ) .'</h3>';
		...
		echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=vw_pet_shop_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'vw-pet-shop' ) .'</a></p>';
	echo '</div>';
}
...
/* admin bar */
function vw_pet_shop_my_filter_head(){
	remove_action('wp_head','_admin_bar_bump_cb');
}
add_action('get_header','vw_pet_shop_my_filter_head');
...
if ( ! function_exists( 'vw_pet_shop_credit' ) ) {
	function vw_pet_shop_credit(){
		echo "<a href=".esc_url(VW_PET_SHOP_CREDIT).">".esc_html__('Pet WordPress Theme','vw-pet-shop')."</a>";
	}
}
